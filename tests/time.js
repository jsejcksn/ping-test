...
var mark = moment();
var mark2 = (1 * (365.25 * 24 * 60 * 60 * 1000)) + (1 * (30.4375 * 24 * 60 * 60 * 1000)) + (1 * (7 * 24 * 60 * 60 * 1000)) + (1 * (24 * 60 * 60 * 1000)) + (1 * (60 * 60 * 1000)) + (1 * (60 * 1000)) + (1 * (1000));
var mark3 = (3 * (365.25 * 24 * 60 * 60 * 1000)) + (10 * (30.4375 * 24 * 60 * 60 * 1000)) + (2 * (7 * 24 * 60 * 60 * 1000)) + (21 * (24 * 60 * 60 * 1000)) + (19 * (60 * 60 * 1000)) + (45 * (60 * 1000)) + (17.5 * (1000));
